        ...
        <div className="w-full sm:w-1/2 md:w-1/5 p-2 flex">
          <Card className="h-full">
            <CardHeader>
              ...
              <CardDescription>(your day at a glance)<br />utilizes the t3 stack</CardDescription>
            </CardHeader>
            <CardContent>
              <p>
            ...
            <CardFooter>
              <div className="">
                <Button variant={"outline"}>
                  <a href="https://ydaag-better.vercel.app/" target="_blank">
                    take me there
                  </a>
                </Button>
              </div>
        ...
        <div className="w-full sm:w-1/2 md:w-1/5 p-2 flex">
          <Card className="h-full">
            ...
            <CardFooter>
              <div className="mt-11"> 
                <Button variant={"outline"}>
                  <a href="https://social-media-t3.vercel.app/" target="_blank">
                    take me there
                  </a>
                </Button>
              </div>
        ...
        <div className="w-full sm:w-1/2 md:w-1/5 p-2 flex">
          <Card className="h-full">
            ...
            <CardFooter>
              <div className="mt-6"> 
                <Button variant={"outline"}>
                  <a href="https://github.com/owenmccomas/web-sprint-challenge-authentication-and-testing" target="_blank">
                    github
                  </a>
                </Button>
              </div>
